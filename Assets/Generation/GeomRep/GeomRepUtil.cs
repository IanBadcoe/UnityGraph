...
namespace Assets.Generation.GeomRep
{
    public class GeomRepUtil
    {
        public static List<Tuple<float, float>> CurveCurveIntersect(Curve c1, Curve c2)
        {
            ...
            {
                float? pc1 = c1.FindParamForPoint(pts.Item1, 1e-5f, 5e-5f);
                float? pc2 = c2.FindParamForPoint(pts.Item1, 1e-5f, 5e-5f);
            ...
            if (pts.Item2 != null)
            {
                float? pc1 = c1.FindParamForPoint(pts.Item2.Value, 1e-5f, 5e-5f);
                float? pc2 = c2.FindParamForPoint(pts.Item2.Value, 1e-5f, 5e-5f);
